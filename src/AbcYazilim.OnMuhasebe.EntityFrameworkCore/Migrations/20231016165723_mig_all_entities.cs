        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HesapNo = table.Column<string>(type: "NVarChar(20)", maxLength: 20, nullable: false),
                    IbanNo = table.Column<string>(type: "NVarChar(26)", maxLength: 26, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MakbuzNo = table.Column<string>(type: "NVarChar(16)", maxLength: 16, nullable: false),
                    Tarih = table.Column<DateTime>(type: "Date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakipNo = table.Column<string>(type: "NVarChar(20)", maxLength: 20, nullable: true),
                    ...
                    CekHesapNo = table.Column<string>(type: "NVarChar(20)", maxLength: 20, nullable: true),
                    ...
                    AsilBorclu = table.Column<string>(type: "NVarChar(20)", maxLength: 20, nullable: true),
                    Ciranta = table.Column<string>(type: "NVarChar(20)", maxLength: 20, nullable: true),
                    KasaId = table.Column<Guid>(type: "UniqueIdentifier", nullable: true),
                    BankaHesapId = table.Column<Guid>(type: "UniqueIdentifier", nullable: true),
